...
/**
 * Servlet implementation class restws_servlet_confirm_2
 */
@WebServlet("/restws_servlet_confirm_2")
public class restws_servlet_confirm_2 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public restws_servlet_confirm_2() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<br>");
		out.println("<form action=\"/javaee_zth/restws_removetester_servlet\" method=\"post\">");
		out.println("<input type=\"hidden\" name=\"test_stu_number\" value=\""+stu_number+"\" />");
		out.println("<input  value=\"删除\" type=\"submit\"/>");
		out.println("</form>");
